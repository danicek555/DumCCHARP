...
{
    Console.WriteLine("Příště zadej mensi delku zdi!");
    return;  
}
...
Console.WriteLine("Tlouska zdi je " + tlouskaZdi + "m");
Console.WriteLine("Delka steny " + delkaSteny + "m");
Console.WriteLine("Obytny prostor je " + obytnyProstor + "m2");
